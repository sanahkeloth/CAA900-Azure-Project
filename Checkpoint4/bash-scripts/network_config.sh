...
RG_NAME="Student-RG-1202091"     # your student group
LOCATION="canadaeast"    # your location
ID="45"          #unique ID assigned to you

Student_vnet_name="Student-1202091-vnet"
Student_vnet_address="10.3.65.0/24"
Client_Subnet_name="Virtual-Desktop-Client"
Client_Subnet_address="10.3.65.0/24"
